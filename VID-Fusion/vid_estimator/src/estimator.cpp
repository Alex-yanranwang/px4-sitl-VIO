...
bool Estimator::relativePose(Matrix3d &relative_R, Vector3d &relative_T, int &l)
{
    ...
    for (int i = 0; i < WINDOW_SIZE; i++)
    {
        ...
        cout<<"491 corres.size():"<<corres.size()<<endl;
        if (corres.size() > 10)//20
        {
            ...
            cout<<"504 average_parallax"<<average_parallax * 460<<" choose l=" << l << " and newest frame to triangulate the whole structure"<<endl;
            cout<<"505 m_estimator.solveRelativeRT:"<<m_estimator.solveRelativeRT(corres, relative_R, relative_T)<<endl;
            if(average_parallax * 460 > 30 && m_estimator.solveRelativeRT(corres, relative_R, relative_T))
            {
                l = i;
                //ROS_INFO("507 average_parallax %f choose l %d and newest frame to triangulate the whole structure", average_parallax * 460, l);
                return true;
            }
        }
    }
