...
void GazeboRosIMU::LoadThread()
{
  ...
  //std::cout <<"146 gazebo_node_ establish!!!"<<"\n";
  //+ROS_WARN_NAMED("imu", "146 gazebo_node_ establish!!!");
  ...
  //Motor subscriber
  this->motor_sub_ = this->gazebo_node_->Subscribe<std_msgs::msgs::Float>("~/iris/motor_speed/0", 
                &GazeboRosIMU::MotorSpeedCallback, this);
...
////////////////////////////////////////////////////////////////////////////////
// subscribe Motor_speed 1/2/3/4
void GazeboRosIMU::MotorSpeedCallback(MotorSpeedPtr &msg)
{
  gzmsg <<"383 msg:"<<msg->data()<<"\n";
}
