...
namespace gazebo
{
  class GazeboRosIMU : public ModelPlugin
  {
    ...
    private: gazebo::transport::SubscriberPtr motor_sub_;
    ...
    // Protobuf test
    private: typedef const boost::shared_ptr<const std_msgs::msgs::Float> MotorSpeedPtr;
    // subscribe Motor_speed 1/2/3/4
    private: void MotorSpeedCallback(MotorSpeedPtr &msg);
  };
}
#endif
